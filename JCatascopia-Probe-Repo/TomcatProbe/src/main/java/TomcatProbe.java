...
public class TomcatProbe extends Probe {
	...
	public TomcatProbe(String name, int freq){
		...
		parseConfig();
	    String user = config.getProperty("tomcat_username", "user");
	    String pass = config.getProperty("tomcat_password", "password");
	...
	public String getDescription() {
		return "A JCatascopia Probe collecting usage stats from Apache Tomcat. To work, the Tomcat API must be accessible by the specified tomcat user";
	}
