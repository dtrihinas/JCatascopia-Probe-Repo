...
//		}
				...
				if (line.contains("Keyspace: ")){
					...
					if (keyspaces.containsKey(s)){
						...
						while (!(line = b.readLine()).contains("----------------") && line != null){
							//considers both cfstats for cassandra 2.0.X and 2.1.X
							if (line.contains("Space used (total):") || line.contains("Space used (total), bytes:"))
	...
	public String getDescription() {
		return " A JCatascopia Probe collecting read/write latency and load stats from Cassandra database";
	}
